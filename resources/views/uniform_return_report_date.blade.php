                        ...
                        <div id="prodlistDiv" class="row" style="margin: 10px 0;">
                            <div class="col-12" style="padding-right: 0 !important; padding-left: 0 !important;">
                                <table id="prodlist" class="price-table custom-table" style="">
                                    <tr><th style="width: 30%;">Employee</th><th style="width: 20%;">Product</th><th style="width: 20%;">Qty</th></tr>
                                </table>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
        ...
        $('#search').on('click', function(e){
        	...
        	var formData = new FormData();
                ...
                $.ajax({
            		  url: "{{ URL::route('get_return_report_date') }}",
                      method: 'post',
                      data: formData,
                      contentType: false,
                      cache: false,
        ...
        $('body').on('dblclick', '.custom-table tr', function(){
                    	...
                    	$.ajax({
                    		  url: "{{ URL::route('get_return_report_details') }}",
                              method: 'post',
                              data: formData,
                              contentType: false,
                              cache: false,
