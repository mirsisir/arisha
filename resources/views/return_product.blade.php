                        ...
                        <div class="row" style="height:350px; overflow-y: auto; ">
                            <div class="col-8" style=" padding-right: 0 !important;">
                                <table class="price-table custom-table" style="">
                                    <tr><th>SL</th><th style="width: 100px;">Company</th><th>Product</th><th>Qty</th><th>Delete</th></tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#company_id').on('change',function(e){
          $.ajaxSetup({
            ...
            $.ajax({
                url:'{{ url('/admin/product/return/get_product') }}',
                method: 'POST',
                dataType: 'JSON',
        ...
        $('#qnt').on('keyup', function(e){
            ...
            if(e.which == 13){
                ...
                if(company_id == '' || product_id == '' || qnt == ''){
                    
                    alert("Please Fillup All Fields ");
                    return false;
                }
                
                add_product_to_table(company_id, company_name,product_id, product_name, qnt);
        ...
        $('#pur_save').click(function(e){
          ...
          $.ajax({
                ...
                success: function(data){
                    ...
                    alert("Product Return Has Been Completed.!!!");
    ...
    function add_product_to_table(company_id, company_name,product_id, product_name, qnt){
            $('.price-table').show();
            
            $('.price-table').append("<tr><td>"+sl+"</td><td data-comid='"+company_id+"' style='width:200px;' class='name'>"+company_name+"</td><td data-prodid='"+product_id+"' style='width:200px;' class='name'>"+product_name+"</td><td class='qnt'>"+qnt+"</td><td><i class='delete mdi mdi-delete'></i></td></tr>");
            sl =sl + 1;
    }
