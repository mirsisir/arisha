      ...
      <div class="col-12">
             ...
             <div class="card">
                <div class="card-header">
                    <h3>Destroy Report</h3>
                </div>
                <div class="card-body custom-table">
                    
                    <form action="get_destroy_report_date" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-2">
                    ...
                    <table class="custom-table purchase-table" style="display:none;">
                        <tr><th>Date</th><th>Uniform</th><th>Quantity</th><th>Action</th></tr>
            ...
            <!-------------------------------->
                    ...
                    <div id="printdiv" style="font-family:Franklin Gothic Medium; ">
                		...
                		<table id="mid_section" style="width:100%; font-size:16px; display:none;">
                		    ...
                		    <tr><td style="text-align:center; font-size:22px" colspan="2"><b>Uniform Destroy</b></td></tr>
                			<tr><td style="text-align:center; font-size:22px" id="date" colspan="2"><b>Date: </b></td></tr>			    
                		    <tr>
                        ...
                        <div id="prodlistDiv" class="row" style="margin: 10px 0;">
                            <div class="col-12" style="padding-right: 0 !important; padding-left: 0 !important;">
                                <table id="prodlist" class="price-table custom-table" style="">
                                    <tr><th style="width: 30%;">Item</th><th style="width: 20%;">Qty</th></tr>
                                </table>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
        ...
        $('#search').on('click', function(e){
        	...
        	var formData = new FormData();
                ...
                $.ajax({
            		  url: "{{ URL::route('get_product_destroy_report_date') }}",
                      method: 'post',
                      data: formData,
                      contentType: false,
                      cache: false,
        ...
        $('body').on('click', '.delete', function(){
            ...
            if(confirm("Are you Sure to Delete?")){
               var currentRow=$(this).closest("tr");
                ...
                var des_id=currentRow.find("td:eq(0)").attr('data-des_id');
                var p_id = currentRow.find("td:eq(1)").attr('data-pro_id');
                var formData = new FormData();
        	        formData.append('des_id', des_id);
                ...
                $.ajax({
            		  url: "{{ URL::route('product_delete_destroy')}}",
                      method: 'post',
                      data: formData,
                      contentType: false,
                      cache: false,
        ...
        $('body').on('dblclick', '.custom-table tr', function(){
                    ...
                    var des_id=currentRow.find("td:eq(0)").attr('data-des_id');
                    	...
                    	$.ajax({
                    		  url: "{{ URL::route('get_product_destroy_report_details') }}",
                              method: 'post',
                              data: formData,
                              contentType: false,
                              cache: false,
