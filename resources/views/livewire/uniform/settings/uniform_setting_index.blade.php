<div>
    @if($updateMode)
        @include('livewire.uniform.settings.uniform_setting_edit')
    @elseif($createMode)
        @include('livewire.uniform.settings.uniform_setting_create')
    @else
    <div class="card"> 
        <div class="card-header">
            <h3 class="card-title float-left">Uniform List</h3>
            <button wire:click="add" class="btn btn-info float-right" >+ Add Uniform</button>
        </div>
        <div class="card-body">
        ...
        <thead>
            ...
            @foreach($settings as $setting)
                @php $c=$c+1; @endphp
                    ...
                    <button onclick="deleteConfirmation({{$setting->id}})" class="btn btn-sm btn-danger">Delete</button>
                    </td>
                </tr>
            @endforeach
            </tbody>
