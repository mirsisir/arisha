...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><center>  Edit Brand </center></h3>
    </div>
    <div class="card-body">
                ...
                <fieldset>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label style="color: #20a71d;font-size: 15px;" for="Brand Name">Brand Name</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <Button class="btn btn-primary" type="submit" style="margin-top:10px">Update Brand</Button>
                            </div>
