<div>
    @if($updateMode)
        @include('livewire.designation.designation_edit')
    @elseif($createMode)
        @include('livewire.designation.designation_create')
    @else
    <div class="card"> 
        <div class="card-header">
            <h3 class="card-title float-left">Designation List</h3>
            <button wire:click="add" class="btn btn-info float-right" >+ Add Designation</button>
        </div>
        <div class="card-body">
        ...
        <thead>
            ...
            @foreach($designations as $designation)
                @php $c=$c+1; @endphp
                    ...
                    <td>
                    <button wire:click="edit({{ $designation->id }})" class="btn btn-primary btn-sm">Edit</button>
                    <button onclick="deleteConfirmation({{$designation->id}})" class="btn btn-sm btn-danger">Delete</button>
                    </td>
                </tr>
            @endforeach
            </tbody>
