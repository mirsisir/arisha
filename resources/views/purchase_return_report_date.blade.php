             ...
             <div class="card">
                ...
                <div class="card-body custom-table">
                    ...
                    <table class="custom-table purchase-table" style="display:none;">
                        <tr><th>Date</th><th>Supplier</th><th>Supplier Memo</th><th>Product Name</th><th>Quantity</th><th>Total</th><th>Action</th></tr>
                    </table>
            ...
            <!-------------------------------->
                    ...
                    <div id="printdiv" style="font-family:Franklin Gothic Medium; ">
                		...
                		<table id="mid_section" style="width:100%; font-size:16px; display:none;">
                		    ...
                		    <tr><td style="text-align:center; font-size:22px" colspan="2"><b>Stock Return</b></td></tr>
                        ...
                        <div id="prodlistDiv" class="row" style="margin: 10px 0;">
                            <div class="col-12" style="padding-right: 0 !important; padding-left: 0 !important;">
                                <table id="prodlist" class="price-table custom-table" style="">
                                    <tr><th style="width: 30%;">Item</th><th style="width: 20%;">Qty</th><th style="width: 20%;">Total</th></tr>
                                </table>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
        ...
        $('body').on('click', '.delete', function(){
            ...
            if(confirm("Are you Sure to Delete?")){
                ...
                var s_id=currentRow.find("td:eq(1)").attr('data-supp_id');
                var s_memo = currentRow.find("td:eq(2)").attr('data-supp_memo');
                var p_id = currentRow.find("td:eq(3)").attr('data-pro_id');

                
                var formData = new FormData();
        	        formData.append('s_id', s_id);
                    formData.append('s_memo', s_memo);
        ...
        $('body').on('dblclick', '.custom-table tr', function(){
                    	...
                    	$.ajax({
                    		  url: "{{ URL::route('get_purchase_return_details') }}",
                              method: 'post',
                              data: formData,
                              contentType: false,
                              cache: false,
                              ...
                              success: function(data){
                                 ...
                                 var trow = obj.trow;
                                 var date = obj.date;
                                 var supp_name = obj.supp_name;
                                 var supp_memo = obj.supp_memo;
                                 var supp_phone = obj.supp_phone;
                                 ...
                                 $("#cust_add").show();
                    	 		 ...
                    	 		 $("#cust_add").append("Supplier: "+supp_name+"<br>");
                                 $("#cust_add").append("Phone: "+supp_phone+"<br>");
                                 $("#cust_add").append("Memo: "+supp_memo+"<br>");
                                 $("#cust_add").append("Date: "+date);
                                 $("#cust_add").append(" &nbsp; ");
